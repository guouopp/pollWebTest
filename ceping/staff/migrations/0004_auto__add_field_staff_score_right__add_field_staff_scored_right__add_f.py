...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.score_right'
        db.add_column(u'staff_staff', 'score_right',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Staff.scored_right'
        db.add_column(u'staff_staff', 'scored_right',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Staff.score'
        db.add_column(u'staff_staff', 'score',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.score_right'
        db.delete_column(u'staff_staff', 'score_right')

        # Deleting field 'Staff.scored_right'
        db.delete_column(u'staff_staff', 'scored_right')

        # Deleting field 'Staff.score'
        db.delete_column(u'staff_staff', 'score')
