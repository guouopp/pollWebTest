...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.had_poll'
        db.add_column(u'staff_staff', 'had_poll',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Staff.poll_num'
        db.add_column(u'staff_staff', 'poll_num',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.had_poll'
        db.delete_column(u'staff_staff', 'had_poll')

        # Deleting field 'Staff.poll_num'
        db.delete_column(u'staff_staff', 'poll_num')
